---
source_path: UI/UI_Gen_TC_From_TD.txt
...
7. "Test Data"
   ...
   - Nếu Test Design nói `Boundary length: 0,1,20,21`:
     + Có thể tạo nhiều Test Case, mỗi case 1 giá trị cụ thể:
       * Case 1: Username=[REDACTED_CREDENTIAL] (length=0)
       * Case 2: Username=[REDACTED_CREDENTIAL] (length=1)
       * Case 3: Username=[REDACTED_CREDENTIAL] (length=20)
       * Case 4: Username=[REDACTED_CREDENTIAL] (length=21)
...
- Trong ô có thể xuống dòng logic bằng ký tự \n (KHÔNG xuống dòng thật).
   ...
   - Ví dụ:
     ...
     2. Nhập Username=[REDACTED_CREDENTIAL] vào ô "Tên đăng nhập"
     3. Nhập Password=[REDACTED_CREDENTIAL] vào ô "Mật khẩu"
