...
def classify_intent(manifest: SourceManifest) -> IntentClassification:
    ...
    request_type = infer_request_type(source_roles, intents)
    confidence = score_confidence(request_type, source_roles, intents)
    alternatives = infer_alternatives(request_type, source_roles, intents)
    missing_inputs = []
...
def infer_request_type(source_roles: list[str], intents: list[str]) -> str:
...
def infer_alternatives(request_type: str, source_roles: list[str], intents: list[str]) -> list[str]:
