...
- Review/handoff legacy `.xlsx` exports must use formatted mode from `scripts/export_legacy_19col_xlsx.py --formatted`.
- Step/data/expected-result cells must render logical `\n` or `/n` markers as real Excel line breaks with wrap text enabled.
